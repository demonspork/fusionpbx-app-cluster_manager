<?php
	...
	//default settings
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "cc6f1a7e-e6a6-4752-9ef6-1c89129207ae";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "cluster_manager";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "udp_port";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "numeric";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "5060";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "SIP UDP Port for SRV records";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "f62299ef-b92c-4c80-b9ca-f35e1da5e442";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "cluster_manager";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "tcp_port";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "numeric";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "5060";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "SIP TCP Port for SRV records";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "197c20ef-4c2d-406f-9496-5aed3d2d0b44";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "cluster_manager";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "tls_port";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "numeric";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "5061";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "SIP TLS Port for SRV records";
		$y++;
